 ...
 *
 */
public class FileDeliveryReportView extends GridLayoutContainer implements FileDeliveryReportPresenter.Display {
	...
	protected void onRender(Element parent, int index) {
	    ...
	    this.proxy = new PagingModelMemoryProxy(fileDeliveryList);
	    this.proxy.setData(fileDeliveryList);
	    this.loader = new BasePagingLoader<PagingLoadResult<ModelData>>(this.proxy);  
	    this.loader.setRemoteSort(true);  
	    ListStore<FileDeliveryDetails> fileDeliveryStore = new ListStore<FileDeliveryDetails>(loader);
